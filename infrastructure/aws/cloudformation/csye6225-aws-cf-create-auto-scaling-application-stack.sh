...
CODEDEPLOYAPPLICATIONNAME="csye6225CodeDeployApplication"
...
export instanceProfileName=$(aws iam list-instance-profiles --query InstanceProfiles[].InstanceProfileName --output text| awk '{print $1}')
